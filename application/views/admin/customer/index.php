    ...
    $(document).ready(function () {
        $.dataTablesSettings = {
            ...
            columns: [{
                ...
                data: function (mdata) {
                    return '<span class="password" data-password="'+mdata.password+'">*******</span> <i onclick="setPassword(this)" style="cursor: pointer;font-size: 14px;" class="fa fa-eye"></i>'
                },
            },{
                data: "date_entered",
            },{
